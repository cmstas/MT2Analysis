...
LOGDIR="/data/tmp/${USERNAME}/condor_submit_logs/ShortTrackSkim/${TAG}/${SUBDIR}"
OUTDIR="/data/tmp/${USERNAME}/condor_job_logs/ShortTrackSkim/${TAG}/${SUBDIR}"
...
COPYDIR=/hadoop/cms/store/user/${USERNAME}/ShortTrackSkim/${TAG}/${SUBDIR}
