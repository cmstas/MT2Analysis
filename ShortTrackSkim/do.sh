...
OUTDIR=/nfs-6/userdata/dpgilber/MT2ST_skim
LOGDIR=logs
...
for SAMPLE in ${Samples[@]}; do
    echo "nohup nice -n 10 ./ShortTrackSkim.exe ${INDIR} ${SAMPLE} ${OUTDIR} >& ${LOGDIR}/${SAMPLE}.log &"
    eval "nohup nice -n 10 ./ShortTrackSkim.exe ${INDIR} ${SAMPLE} ${OUTDIR} >& ${LOGDIR}/${SAMPLE}.log &"
done