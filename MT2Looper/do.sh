...
OUTDIR=output/V00-10-16_2016fullYear/
# OUTDIR=output/V00-10-16_2017fullYear/
# OUTDIR=output/V00-10-18_2018fullYear/
# OUTDIR=output/V00-10-16_2018fullYear_17fastsim
...
INDIR=/nfs-7/userdata/mt2/V00-10-18_2018fullYear_skim_base/
...
# declare -a Samples=(dyjetsll zinv)
...
# declare -a Samples=(data_Run2018D)
...
INDIR=/nfs-7/userdata/mt2/V00-10-17_2018fullYear_skim_base/
# INDIR=/nfs-7/userdata/mt2/V00-10-16_2017fullYear_skim_base/
# INDIR=/nfs-6/userdata/dpgilber/ShortTrackScanBaseSkims
# declare -a Samples=(T1tttt T1bbbb T1qqqq T2tt T2bb T2qq)
# declare -a Samples=(T1tttt T1bbbb T1qqqq T2bb T2qq T2cc T2bt T2bW T2tt_mStop150to250 T2tt_mStop250to350 T2tt_mStop350to400 T2tt_mStop400to1200 T2tt_mStop1200to2000) 
# declare -a Samples=(T1tttt T1bbbb T1qqqq T2bb T2qq T2cc T2bt T2bW) 
...
# declare -a Samples=(T2cc T2bt T2bW) 
# declare -a Samples=(T1bbbb T1qqqq T2bb rpvMonoPhi)
declare -a Samples=(T2WW) 
# declare -a Samples=(T2tt_mStop150to250 T2tt_mStop250to350 T2tt_mStop350to400 T2tt_mStop400to1200 T2tt_mStop1200to2000 extraT2tt T2bt T2bW T1tttt) 
...
# declare -a Samples=(T2cc T2bt T2bW) 
declare -a Samples=(T2WW) 
# declare -a Samples=(rpvMonoPhi) 
# declare -a Samples=(extraT2tt) 
...
INDIR=/nfs-7/userdata/mt2/V00-10-16_2016fullYear_skim_base/
# declare -a Samples=(T1tttt T1bbbb T1qqqq T2tt T2bb T2qq)
# declare -a Samples=(T1tttt T1bbbb T1qqqq T2bb T2qq T2cc T2bt T2bW T2tt_mStop150to250 T2tt_mStop250to350 T2tt_mStop350to400 T2tt_mStop400to1200 T2tt_mStop1200to2000)
# declare -a Samples=(T1tttt T1bbbb T1qqqq T2bb T2qq T2cc T2bt T2bW)
# declare -a Samples=(T2tt_mStop150to250 T2tt_mStop250to350 T2tt_mStop350to400 T2tt_mStop400to1200 T2tt_mStop1200to2000)
