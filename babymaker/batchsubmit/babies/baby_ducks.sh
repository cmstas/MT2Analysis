...
gfal-copy -p -f -t 4200 file://`pwd`/output.root srm://bsrm-3.t2.ucsd.edu:8443/srm/v2/server?SFN=/hadoop/cms/store/user/dpgilber/AutoTwopler_babies/${ANALYSIS}_${BABY_TAG}/${SHORTNAME}//output/output_${IMERGED}.root --checksum ADLER32

gfal-copy -p -f -t 4200 file://`pwd`/skim.root srm://bsrm-3.t2.ucsd.edu:8443/srm/v2/server?SFN=/hadoop/cms/store/user/dpgilber/AutoTwopler_babies/${ANALYSIS}_${BABY_TAG}/${SHORTNAME}//skim/skim_${IMERGED}.root --checksum ADLER32

gfal-copy -p -f -t 4200 file://`pwd`/skim_rphi.root srm://bsrm-3.t2.ucsd.edu:8443/srm/v2/server?SFN=/hadoop/cms/store/user/dpgilber/AutoTwopler_babies/${ANALYSIS}_${BABY_TAG}/${SHORTNAME}//skim_rphi/skim_rphi_${IMERGED}.root --checksum ADLER32
