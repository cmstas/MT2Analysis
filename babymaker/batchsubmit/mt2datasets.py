...
def getMC2016():
    ...
    wjets_map = {
        ...
        "/WJetsToLNu_HT-800To1200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/RunIISummer16MiniAODv3-PUMoriond17_94X_mcRun2_asymptotic_v3-v1/MINIAODSIM"  : "wjets_800to1200",
        }
    gjets_map = {
    ...
    mc_map = {} 
    for background in [ttbar_map, singletop_map, ttX_map, zinv_map, qcd_map, dy_map, wjets_map, gjets_map, multiboson_map]: mc_map.update(background) 
    return mc_map
