...
# INDIR=/nfs-6/userdata/mt2/V00-08-07_nojson_skim_base_mt2gt200_ZinvV6
...
declare -a Samples=(ttsl ttdl wjets_ht zinv_ht gjets_dr0p05_ht singletop ttw ttz ttg qcd_ht)
