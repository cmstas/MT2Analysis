...
# #individual signal points for testing
# INDIR=/nfs-6/userdata/mt2/2016_ichep_individual_signal_skims
# declare -a Samples=(T1bbbb_2000_1)
...
declare -a Samples=(T1qqqq_ctau-0p001 T1qqqq_ctau-0p01 T1qqqq_ctau-0p1 T1qqqq_ctau-1 T1qqqq_ctau-10 T1qqqq_ctau-100 T1qqqq_ctau-1000 T1qqqq_ctau-10000 T1qqqq_ctau-100000 T1qqqq_ctau-1e18)

# INDIR=.
# declare -a Samples=(T1qqqq_ctau-0p001)
