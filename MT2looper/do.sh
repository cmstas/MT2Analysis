...
declare -a Samples=(ttsl ttdl wjets_ht 2015zinv_ht gjets_dr0p05_ht singletop ttw ttz ttg qcd_ht data_Run2016B data_Run2016C)
# declare -a Samples=(data_Run2016B data_Run2016C)
