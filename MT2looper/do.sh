...
# declare -a Samples=(data_Run2016B ttsl ttdl zinv_ht wjets_ht singletop ttw ttz ttg)
# declare -a Samples=(data_Run2016B ttsl ttdl 2015zinv_ht wjets_ht singletop ttw ttz ttg)
