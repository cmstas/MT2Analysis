...
dir_sigma15 = "looper_output/V00-10-04_ptBinned_94x_JetID_PUID_BTagSFs_core2sigma_sigmasoft15/qcd"
dir_sigma25 = "looper_output/V00-10-04_ptBinned_94x_JetID_PUID_BTagSFs_core2sigma_sigmasoft25/qcd"
dir_noRS = "../SmearLooper/output/V00-10-04_94x_2017_noRS/"

hrs = ROOT.TH1D("hrs","",51,0,51)
h15 = ROOT.TH1D("h15","",51,0,51)
h25 = ROOT.TH1D("h25","",51,0,51)
hnrs = ROOT.TH1D("hnrs","",51,0,51)

h_evts_rs = ROOT.TH1D("h_evts_rs","",1,0,2)
h_evts_15 = ROOT.TH1D("h_evts_15","",1,0,2)
...
for ht_reg in ["VL","L","M","H","UH"]:
    ...
    for top_reg in top_regs:
        ...
        f15 = ROOT.TFile(os.path.join(dir_sigma15,bn))
        f25 = ROOT.TFile(os.path.join(dir_sigma25,bn))
        ...
        try:
            ...
            pass
        try:
            h_evts_15.Add(f15.Get("sr{0}{1}/h_Events_w".format(top_reg,ht_reg)))
        except:
            pass
        try:
        ...
        h15.SetBinContent(ibin, h_evts_15.GetBinContent(1))
        h15.SetBinError(ibin, h_evts_15.GetBinError(1))
        ...
        sum_rs15 += h_evts_15.GetBinContent(1)
        sum_rs25 += h_evts_25.GetBinContent(1)
        
    print "{0} HT: rs = {1}, rs15 = {2}, ratio = {3}".format(ht_reg, sum_rs, sum_rs15, sum_rs15/sum_rs)
...
leg = ROOT.TLegend(0.73,0.75,0.94,0.9)
leg.AddEntry(hnrs, "QCD MC")
leg.AddEntry(hrs, "R&S (#sigma_{soft} = 20 GeV)")
leg.AddEntry(h15, "R&S (#sigma_{soft} = 15 GeV)")
leg.AddEntry(h25, "R&S (#sigma_{soft} = 25 GeV)")
leg.Draw()
...
h_ratio15 = h15.Clone("h_ratio")
h_ratio15.Divide(hrs)

h_ratio25 = h25.Clone("h_ratio")
h_ratio25.Divide(hrs)

h_ratio15.GetYaxis().SetRangeUser(0,2)
h_ratio15.GetYaxis().SetNdivisions(505)
h_ratio15.GetYaxis().SetTitle("Shift/R&S")
h_ratio15.GetYaxis().SetTitleSize(0.16)
h_ratio15.GetYaxis().SetTitleOffset(0.18)
h_ratio15.GetYaxis().SetLabelSize(0.13)
h_ratio15.GetYaxis().CenterTitle()
h_ratio15.GetYaxis().SetTickLength(0.02)
h_ratio15.GetXaxis().SetLabelSize(0)
h_ratio15.GetXaxis().SetTitle("")
h_ratio15.GetXaxis().SetNdivisions(51,0,0)
h_ratio15.GetXaxis().SetTickSize(0.06)
h_ratio15.SetMarkerStyle(20)
h_ratio15.SetMarkerSize(1.0)
h_ratio15.SetLineWidth(1)
...
c.SaveAs("/home/users/bemarsh/public_html/mt2/RebalanceAndSmear/{0}/mc_sigmasoft_var.pdf".format(tag))
c.SaveAs("/home/users/bemarsh/public_html/mt2/RebalanceAndSmear/{0}/mc_sigmasoft_var.png".format(tag))
