...
# INDIR=/hadoop/cms/store/user/bemarsh/mt2babies/RebalanceAndSmear_V00-10-14_2017fullYear_data_Run2017D_JetHT_31Mar2018/
INDIR=.
...
declare -a Samples=(testEvents_forFrank)
...
for SAMPLE in ${Samples[@]};
  ...
  nohup nice -n 10 ./runLooper ${INDIR} ${SAMPLE} ${OUTDIR} -d -r -l 3 -b -g $CONFIG -n 1000 >& ${LOGDIR}/log_${SAMPLE}.txt&
done
