...
for hist in [h_factor_stc1,h_factor_stc2,h_factor_st1,h_factor_st2]:
    ...
    hist.SetLineWidth(3)
    hist.Draw("E")
    canvas2.SaveAs("{0}/{1}L.png".format(outdir,hist.GetName()))
...
for hist in [h_factor_stc1,h_factor_stc2,h_factor_st1,h_factor_st2]:
    ...
    hist.SetLineWidth(3)
    hist.Draw("E")
    canvas2.SaveAs("{0}/{1}M.png".format(outdir,hist.GetName()))
...
for hist in [h_factor_stc1,h_factor_stc2,h_factor_st1,h_factor_st2]:
    ...
    hist.SetLineWidth(3)
    hist.Draw("E")
    canvas2.SaveAs("{0}/{1}H.png".format(outdir,hist.GetName()))
