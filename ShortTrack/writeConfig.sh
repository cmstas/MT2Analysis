...
if [ "$#" -ne 2 ]; then
    echo "Usage: ./writeConfig.sh DATADIR TAG"
    exit
fi
...
LOGDIR="/nfs-6/userdata/${USERNAME}/condor_submit_logs/ShortTrack"
OUTDIR="/nfs-6/userdata/${USERNAME}/condor_job_logs/ShortTrack"
...
# The extra /*/ covers nonext, ext1, etc
...
echo "[writeConfig] wrote condor/condor_${TAG}.cmd" 
