...
LOGDIR="/data/tmp/${USERNAME}/condor_submit_logs/ShortTrackLooper/${TAG}/${SUBDIR}"
OUTDIR="/data/tmp/${USERNAME}/condor_job_logs/ShortTrackLooper/${TAG}/${SUBDIR}"
...
COPYDIR=/hadoop/cms/store/user/${USERNAME}/ShortTrackLooper/${TAG}/${SUBDIR}
