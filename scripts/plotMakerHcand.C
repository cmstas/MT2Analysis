...
void plotMakerHcand() {
  ...
  // vector<string> names = {"ttdl", "sig_T5qqqqWH_1400_700", "sig_T5qqqqWH_1400_200"};
  // vector<string> names = {"ttdl", "sig_T5qqqqWH_1400_700", "sig_T5qqqqWH_1400_200"};
  ...
  if (printplots) {
    ...
    while ((k = (TKey *)it())) {
      ...
      makePlot( samples , names , dir_name , "h_mt2"+s , "M_{T2} [GeV]" , "Events / 50 GeV" , 0 , 1000 , 5 , false, printplots, scalesig, doRatio, scaleBGtoData );
