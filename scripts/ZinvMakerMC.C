...
//_______________________________________________________________________________
void ZinvMakerMC(string input_dir = "/home/users/bemarsh/analysis/mt2/current/MT2Analysis/MT2looper/output/V00-09-02_21p15fb"){
  ...
  TFile* f_data = new TFile(Form("%s/background.root",input_dir.c_str()));
