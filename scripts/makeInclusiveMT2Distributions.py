...
if generateHists:
    ...
    sel = "nJet30>=2 && mt2>0 && ht>200 && nElectrons10+nMuons10+nPFLep5LowMT+nPFHad10LowMT==0"
    ...
    print "T1qqqqO"
    cT1qqqq.Draw("mt2>>hT1qqqqO", "evt_scale1fb*({0} && GenSusyMScan1==2000 && GenSusyMScan2==100)".format(sel), "goff")
    print "T1qqqqC"
    cT1qqqq.Draw("mt2>>hT1qqqqC", "evt_scale1fb*({0} && GenSusyMScan1==1400 && GenSusyMScan2==1100)".format(sel), "goff")
    
    
    fout = r.TFile("../scratch/blah.root", "RECREATE")
    hqcd.Write()
    hwjets.Write()
    htop.Write()
    hzinv.Write()
...
hqcd.Scale(10 * 137.4)
htop.Scale(10 * 137.4)
hwjets.Scale(10 * 137.4)
hzinv.Scale(10 * 137.4)
hT1ttttO.Scale(10000 * 137.4 * 0.000598 * 1000 / 48057)
hT1ttttC.Scale(10000 * 137.4 * 0.008870 * 1000 / 53387)
hT1bbbbO.Scale(10000 * 137.4 * 0.000356 * 1000 / 22356)
hT1bbbbC.Scale(10000 * 137.4 * 0.008870 * 1000 / 23988)
hT1qqqqO.Scale(10000 * 137.4 * 0.001010 * 1000 / 25493)
hT1qqqqC.Scale(10000 * 137.4 * 0.028400 * 1000 / 48013)
...
hdummy.Reset()
hdummy.GetYaxis().SetRangeUser(1e2, 1e12)
...
hT1qqqqO.SetLineColor(r.kBlack)
...
leg.AddEntry(hT1qqqqO, "T1qqqq (2000, 100) #times10", 'l')
...
text.SetTextFont(52)
text.DrawLatex(c.GetLeftMargin()+0.105, 1.0-c.GetTopMargin()+0.01, "Simulation")
text.SetTextFont(42)
...
text.SetTextAlign(11)
text.DrawLatex(c.GetLeftMargin()+0.08, 1.0-c.GetTopMargin()-0.07, "H_{T} > 200 GeV")
text.DrawLatex(c.GetLeftMargin()+0.08, 1.0-c.GetTopMargin()-0.13, "#geq2j, #geq0b")
