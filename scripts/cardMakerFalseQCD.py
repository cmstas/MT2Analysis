...
#    dir_zgratio = f_zgratio.Get(directory)
    ...
    pj_LOW_name = directory + "/h_PJ1eta_LOW"
    pj_HI_name = directory + "/h_PJ1eta_HI"
    h_pj_LOW = f_sig.Get(pj_LOW_name)
    h_pj_HI = f_sig.Get(pj_HI_name)
    pj_LOW = h_pj_LOW.GetBinContent(1) if h_pj_LOW != None else 0
    pj_HI = h_pj_HI.GetBinContent(1) if h_pj_HI != None else -1            
    ...
    topologicalR = "{0}_{1}_{2}_{3}".format(ht_str,jet_str,bjet_str,pj_str)
    ...
    name_lostlep_shape = "llep_shape_{0}_{1}_{2}_{3}".format(ht_str_crsl,jet_str_crsl,bjet_str_crsl,pj_str_crsl)
    name_lostlep_crstat = "llep_CRstat_{0}_{1}_{2}_{3}".format(ht_str_crsl,jet_str_crsl,bjet_str_crsl,pj_str_crsl)
    name_lostlep_alphaerr = "llep_alpha_{0}_{1}_{2}_{3}".format(ht_str_crsl,jet_str_crsl,bjet_str_crsl,pj_str_crsl)
