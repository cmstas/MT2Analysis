...
rm -r $OUTDIR/hcand $OUTDIR/Hcand $OUTDIR/Zcand
...
declare -a samples=(T2ttZH_800_200 T2ttZH_800_400 T5qqqqWH_1100_950 T5qqqqWH_1400_700 T2bb T2tt)
# declare -a samples=(T2ttZH_800_200)
