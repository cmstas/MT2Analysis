...
void plot2d()
{
  ...
  TH2F* h1 = (TH2F*) f_ttbar->Get("srsmbase/h2d_nlep_frtau_mpt5-10");
  TH2F* h2 = (TH2F*) f_ttbar->Get("srsmbase/h2d_nlep_frtau_mpt10-15");
  TH2F* h3 = (TH2F*) f_ttbar->Get("srsmbase/h2d_nlep_frtau_mpt15-20");
  //Th2f* h4 = (TH2F*) f_ttbar->Get("srsmbase/h2d_receff_genmupt");

  //h->Draw();
  PlotMaker2D(h1, "--colors --outputName ngenLep_frtau_mpt5-10");
  PlotMaker2D(h2, "--colors --outputName ngenLep_frtau_mpt10-15");
  PlotMaker2D(h3, "--colors --outputName ngenLep_frtau_mpt15-20");
