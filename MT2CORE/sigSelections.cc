...
namespace mt2 {
  ...
  std::vector<SR> getSignalRegions2018(){
    ...
    // The 7+ jet regions, 7-9, 11 (indices 6-8, 10) are VL, L only
    sr.SetName("7");
    sr.SetVar("njets", 7, -1);
    sr.SetVar("nbjets", 0, 1);
    sr.SetVarCRSL("njets", 7, -1);
    ...
    // Regions 20+ are M, H, UH only (indices 19+)
    // All 7+ jet regions share the 7+j control regions, 0b and 1+b
    sr.SetName("20");
    sr.SetVar("njets", 7, 10);
    sr.SetVar("nbjets", 0, 1);
    sr.SetVarCRSL("njets", 7, -1);
