...
namespace mt2 {
  ...
  std::vector<SR> getSignalRegions2018(){
    ...
    for(unsigned int iSR = 0; iSR < temp_SR_vec.size(); iSR++){
      ...
      int njets_lo = fullSR.GetLowerBound("njets");
      int nbjets_lo = fullSR.GetLowerBound("nbjets");
      if     (njets_lo == 2 && nbjets_lo == 0){float mt2bins[8] = {200, 400, 600, 800, 1000, 1200, 2400}; fullSR.SetMT2Bins(6, mt2bins);}
      ...
      else if(njets_lo == 4 && nbjets_lo == 0){float mt2bins[8] = {200, 400, 600, 800, 1000, 1200, 2400}; fullSR.SetMT2Bins(6, mt2bins);}
    ...
    sr.SetVarCRQCD("ht", 1000, -1);
    sr.SetVarCRQCD("met", 30, -1);
    float mt2bins_sr30[] = {200, 400, 600, 800, 1000, 1200, 1800};
    ...
    sr.SetVarCRQCD("ht", 1500, -1);
    sr.SetVarCRQCD("met", 30, -1);
    float mt2bins_sr31[] = {200, 400, 600, 800, 1000, 1400, 1800};
    ...
    sr.SetVarCRQCD("ht", 1000, -1);
    sr.SetVarCRQCD("met", 30, -1);
    float mt2bins_sr32[] = {200, 400, 600, 800, 1000, 1200, 1800};
    ...
    sr.SetVarCRQCD("ht", 1500, -1);
    sr.SetVarCRQCD("met", 30, -1);
    float mt2bins_sr33[] = {200, 400, 600, 800, 1000, 1400, 1800};
    ...
    sr.SetVarCRQCD("ht", 1000, -1);
    sr.SetVarCRQCD("met", 30, -1);
    float mt2bins_sr34[] = {200, 400, 600, 800, 1000, 1800};
    ...
    sr.SetVarCRQCD("ht", 1500, -1);
    sr.SetVarCRQCD("met", 30, -1);
    float mt2bins_sr35[] = {200, 400, 600, 800, 1000, 1800};
    ...
    sr.SetVarCRQCD("ht", 1000, -1);
    sr.SetVarCRQCD("met", 30, -1);
    float mt2bins_sr36[] = {200, 400, 600, 800, 1000, 1800};
    ...
    sr.SetVarCRQCD("ht", 1500, -1);
    sr.SetVarCRQCD("met", 30, -1);
    float mt2bins_sr37[] = {200, 400, 600, 800, 1800};
    sr.SetMT2Bins(4, mt2bins_sr37);
    SRVec.push_back(sr);
    sr.Clear();
    ...
    sr.SetVarCRQCD("ht", 1000, -1);
    sr.SetVarCRQCD("met", 30, -1);
    float mt2bins_sr38[] = {200, 400, 600, 1800};
    sr.SetMT2Bins(3, mt2bins_sr38);
    SRVec.push_back(sr);
    sr.Clear();
    ...
    sr.SetVarCRQCD("ht", 1500, -1);
    sr.SetVarCRQCD("met", 30, -1);
    float mt2bins_sr39[] = {200, 400, 600, 1800};
    sr.SetMT2Bins(3, mt2bins_sr39);
    SRVec.push_back(sr);
    sr.Clear();
    ...
    sr.SetVarCRQCD("ht", 1000, -1);
    sr.SetVarCRQCD("met", 30, -1);
    float mt2bins_sr40[] = {200, 400, 600, 1800};
    ...
    sr.SetVarCRQCD("ht", 1500, -1);
    sr.SetVarCRQCD("met", 30, -1);
    float mt2bins_sr41[] = {200, 400, 1800};
    sr.SetMT2Bins(2, mt2bins_sr41);
    SRVec.push_back(sr);
    sr.Clear();
