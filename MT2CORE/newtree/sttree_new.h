...
public :
   ...
   Int_t           track_PBHitPattern[200]; //[ntracks]
   Int_t           track_PEHitPattern[200]; //[ntracks]
   Int_t           track_TIBHitPattern[200]; //[ntracks]
   Int_t           track_TOBHitPattern[200]; //[ntracks]
   Int_t           track_TIDHitPattern[200]; //[ntracks]
   Int_t           track_TECHitPattern[200]; //[ntracks]
   ...
   TBranch         *b_track_PBHitPattern;
   TBranch         *b_track_PEHitPattern;
   TBranch         *b_track_TIBHitPattern;
   TBranch         *b_track_TOBHitPattern;
   TBranch         *b_track_TIDHitPattern;
   TBranch         *b_track_TECHitPattern;
...
void sttree::Init_ST(TTree *tree)
{
   ...
   fChain->SetBranchAddress("track_PBHitPattern", track_PBHitPattern, &b_track_PBHitPattern);
   fChain->SetBranchAddress("track_PEHitPattern", track_PEHitPattern, &b_track_PEHitPattern);
   fChain->SetBranchAddress("track_TIBHitPattern", track_TIBHitPattern, &b_track_TIBHitPattern);
   fChain->SetBranchAddress("track_TOBHitPattern", track_TOBHitPattern, &b_track_TOBHitPattern);
   fChain->SetBranchAddress("track_TIDHitPattern", track_TIDHitPattern, &b_track_TIDHitPattern);
   fChain->SetBranchAddress("track_TECHitPattern", track_TECHitPattern, &b_track_TECHitPattern);
