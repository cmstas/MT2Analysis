...
MT2Configuration GetMT2Config(std::string tag){
    ...
    if(tag == "data_2016_94x"){
        ...
        c.elSF_IDISOfile     = "lepsf/FullRunII/ElectronScaleFactors_Run2017.root";
        c.elSF_TRKfile       = "lepsf/FullRunII/egammaEffi.txt_EGM2D_runBCDEF_passingRECO.root";
        c.elSF_IDhistName    = "Run2017_CutBasedVetoNoIso94XV2";
        c.elSF_ISOhistName   = "Run2017_MVAVLooseTightIP2DMini";
        c.muSF_IDfile        = "lepsf/FullRunII/MuonPOG_SF_ID_2017BCDEF.root";
        c.muSF_ISOfile       = "lepsf/FullRunII/SUS_MuSF_MiniIso2_LooseID.root";
        c.muSF_IPfile        = "";
        c.muSF_TRKfile       = "";
