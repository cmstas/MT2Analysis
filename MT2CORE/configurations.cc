...
MT2Configuration GetMT2Config(std::string tag){
    ...
    if(tag == "data_2016_94x"){
        ...
        c.year               = 2018;
        c.cmssw_ver          = 102;
        c.json               = "Cert_314472-325175_13TeV_17SeptEarlyReReco2018ABC_PromptEraD_Collisions18_JSON_snt.txt";
        c.lumi               = 59.74;
        ...
        c.JECs.push_back(std::pair<std::string, std::string> ("2018A", "Autumn18_RunA_V8_DATA"));
        c.JECs.push_back(std::pair<std::string, std::string> ("2018B", "Autumn18_RunB_V8_DATA"));
        c.JECs.push_back(std::pair<std::string, std::string> ("2018C", "Autumn18_RunC_V8_DATA"));
        c.JECs.push_back(std::pair<std::string, std::string> ("2018D", "Autumn18_RunD_V8_DATA"));
        c.filters["eeBadScFilter"] = true;
        c.filters["globalSuperTightHalo2016Filter"] = true;
        c.filters["goodVertices"] = true;
        c.filters["HBHENoiseFilter"] = true;
        ...
        c.muSF_IDfile        = "lepsf/Autumn18/MuonPOG_RunABCD_SF_ID.root";
        ...
        c.JRT_file           = "JetResponseTemplates_ptBinned_102x_JetID_PUID_BTagSFs_core2sigma.root";
        c.rphi_tag           = "V00-10-09_2018fullYear";
        c.JECs.push_back(std::pair<std::string, std::string> ("", "Autumn18_V8_MC"));
        c.filters["globalSuperTightHalo2016Filter"] = true;
        c.filters["goodVertices"] = true;
        c.filters["HBHENoiseFilter"] = true;
        c.filters["HBHENoiseIsoFilter"] = true;
        ...
        c.btagcalib_csv      = "DeepCSV_102XSF_V1.csv";
        c.btageff_file       = "btageff__DeepCSV_ttbar_MG_pythia8_25ns_Autumn18.root";
        c.btagcalib_csv_fastsim      = "DeepCSV_102X_2018_Fastsim.csv";
        c.btageff_file_fastsim       = "btageff__DeepCSV_SMS_T2tt_fastsim_Autumn18.root";
        c.btag_med_threshold_DeepCSV = 0.4184;
        c.btag_med_threshold_CSVv2   = 0.8838;
        c.pu_weights_file    = "puWeight2018.root";
        c.elSF_IDISOfile     = "lepsf/Autumn18/ElectronScaleFactors_Run2018.root";
        ...
        c.JRT_file           = "JetResponseTemplates_ptBinned_102x_JetID_PUID_BTagSFs_core2sigma.root";
        c.rphi_tag           = "V00-10-09_2018fullYear";
        c.JECs.push_back(std::pair<std::string, std::string> ("", "Autumn18_FastsimV1"));
        c.filters["goodVertices"] = true;
        c.filters["HBHENoiseFilter"] = true;
        c.filters["HBHENoiseIsoFilter"] = true;
        c.filters["EcalDeadCellTriggerPrimitiveFilter"] = true;
        ...
        c.btagcalib_csv      = "DeepCSV_Moriond17_B_H.csv";
        c.btageff_file       = "btageff__DeepCSV_ttbar_MG_pythia8_25ns_Summer16_94x.root";
        c.btagcalib_csv_fastsim      = "DeepCSV_94X_2016_Fastsim.csv";
        c.btageff_file_fastsim       = "btageff__SMS-T1tttt_2016_80X_deepCSV.root";
        c.btag_med_threshold_DeepCSV = 0.6324;
        c.btag_med_threshold_CSVv2   = 0.8484;
        c.pu_weights_file    = "puWeight2016.root";
        c.elSF_IDISOfile     = "lepsf/moriond17/scaleFactors_el_moriond_2017.root";
        ...
        c.muSF_TRKLT10histName = "ratio_eff_eta3_tk0_dr030e030_corr";
        c.muSF_TRKGT10histName = "ratio_eff_eta3_dr030e030_corr";
        c.elSF_IDISOfile_fastsim    = "lepsf/moriond17/sf_el_vetoCB_mini01.root";
        c.elSF_IDhistName_fastsim   = "histo2D";
        c.elSF_ISOhistName_fastsim  = "";
        c.muSF_IDfile_fastsim       = "lepsf/moriond17/sf_mu_looseID.root";
        c.muSF_ISOfile_fastsim      = "lepsf/moriond17/sf_mu_looseID_mini02.root";
        c.muSF_IPfile_fastsim       = "lepsf/moriond17/sf_mu_mediumID_looseIP2D.root";
        c.muSF_IDhistName_fastsim   = "histo2D";
        c.muSF_ISOhistName_fastsim  = "histo2D";
        c.muSF_IPhistName_fastsim   = "histo2D";
        c.dilep_trigeff_file = "lepsf/trigeff/trigeff_dilep_2016fullYear.root";
        c.ea_version         = 1;
        c.jet_id             = "50nsV1";
        c.JRT_file           = "JetResponseTemplates_ptBinned_80x_JetID_PUID_BTagSFs_core2sigma.root";
        ...
        c.btagcalib_csv      = "DeepCSV_94XSF_V3_B_F.csv";
        c.btageff_file       = "btageff__DeepCSV_ttbar_powheg_pythia8_25ns_Fall17.root";
        c.btagcalib_csv_fastsim      = "DeepCSV_94X_2017_Fastsim.csv";
        c.btageff_file_fastsim       = "btageff__SMS-T1tttt_2017_94X_deepCSV.root";
        c.btag_med_threshold_DeepCSV = 0.4941;
        c.btag_med_threshold_CSVv2   = 0.8838;
        c.pu_weights_file    = "puWeight2017.root";
        c.elSF_IDISOfile     = "lepsf/Fall17/ElectronScaleFactors_Run2017.root";
