...
public :
   ...
   Double_t         track_pt[200]; //[ntracks]
   Double_t         track_ptErr[200]; //[ntracks]
   Double_t         track_eta[200]; //[ntracks]
   Double_t         track_phi[200]; //[ntracks]
   Double_t         track_nChi2[200]; //[ntracks]
   Double_t         track_ipSigXY[200]; //[ntracks]
   Double_t         track_ipBSSigXY[200]; //[ntracks]
   Double_t         track_dxy[200]; //[ntracks]
   Double_t         track_dxyBS[200]; //[ntracks]
   Double_t         track_dxyErr[200]; //[ntracks]
   Double_t         track_dz[200]; //[ntracks]
   Double_t         track_dzBS[200]; //[ntracks]
   Double_t         track_dzErr[200]; //[ntracks]
   ...
   Double_t         track_sumChH[200]; //[ntracks]
   Double_t         track_sumChHmini[200]; //[ntracks]
   Double_t         track_sumNeuH[200]; //[ntracks]
   Double_t         track_sumPh[200]; //[ntracks]
   Double_t         track_sumNeuH0p05[200]; //[ntracks]
   Double_t         track_sumPh0p05[200]; //[ntracks]
   Double_t         track_dedx[200]; //[ntracks]
   Double_t         track_dedxPixel[200]; //[ntracks]
   Int_t           track_pfPdgId[200]; //[ntracks]
   Int_t           track_pfCharge[200]; //[ntracks]
   Double_t         track_pfDR[200]; //[ntracks]
   Double_t         track_pfPt[200]; //[ntracks]
   Double_t         track_pfEta[200]; //[ntracks]
   Double_t         track_pfPhi[200]; //[ntracks]
   Int_t           track_anypfPdgId[200]; //[ntracks]
   Int_t           track_anypfCharge[200]; //[ntracks]
   Double_t         track_anypfDR[200]; //[ntracks]
   Double_t         track_anypfPt[200]; //[ntracks]
   Double_t         track_anypfEta[200]; //[ntracks]
   Double_t         track_anypfPhi[200]; //[ntracks]
   Double_t         track_jetDR[200]; //[ntracks]
   Double_t         track_jetPt[200]; //[ntracks]
   Double_t         track_jetEta[200]; //[ntracks]
   Double_t         track_jetPhi[200]; //[ntracks]
   Double_t         track_jetIso[200]; //[ntracks]
   Double_t         track_iso[200]; //[ntracks]
   Double_t         track_isonomin[200]; //[ntracks]
   Double_t         track_reliso[200]; //[ntracks]
   Double_t         track_relisonomin[200]; //[ntracks]
   Double_t         track_iso_nocorr[200]; //[ntracks]
   Double_t         track_reliso_nocorr[200]; //[ntracks]
   Double_t         track_isocorr[200]; //[ntracks]
   Double_t         track_relisocorr[200]; //[ntracks]

   Int_t           ncharginos; 
   Int_t           gp_pdgid[3]; //[ncharginos]
   Double_t         gp_pt[3]; //[ncharginos]
   Double_t         gp_eta[3]; //[ncharginos]
   Double_t         gp_phi[3]; //[ncharginos]
   Int_t           gp_status[3]; //[ncharginos]
   Double_t         gp_decayXY[3]; //[ncharginos]
