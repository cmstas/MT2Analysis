...
std::vector<SRRS> getSignalRegions2018_RS(){
  ...
  for(unsigned int iSR = 0; iSR < temp_SR_vec.size(); iSR++){
    ...
    int njets_lo = fullSR.GetLowerBound("njets");
    int nbjets_lo = fullSR.GetLowerBound("nbjets");
    if     (njets_lo == 2 && nbjets_lo == 0){float mt2bins[11] = {200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 2400}; fullSR.SetMT2Bins(10, mt2bins);}
    else if(njets_lo == 2 && nbjets_lo == 1){float mt2bins[7] = {200, 300, 400, 600, 800, 1000, 2400}; fullSR.SetMT2Bins(6, mt2bins);}
    else if(njets_lo == 2 && nbjets_lo == 2){float mt2bins[6] = {200, 300, 400, 600, 800, 2400};       fullSR.SetMT2Bins(5, mt2bins);}
    else if(njets_lo == 4 && nbjets_lo == 0){float mt2bins[11] = {200, 300, 400, 500, 600, 700, 800, 900, 1000, 1100, 2400}; fullSR.SetMT2Bins(10, mt2bins);}
    else if(njets_lo == 4 && nbjets_lo == 1){float mt2bins[7] = {200, 300, 400, 600, 800, 1000, 2400}; fullSR.SetMT2Bins(6, mt2bins);}
    else if(njets_lo == 4 && nbjets_lo == 2){float mt2bins[6] = {200, 300, 400, 600, 800, 2400};       fullSR.SetMT2Bins(5, mt2bins);}
    else if(njets_lo == 7 && nbjets_lo == 0){float mt2bins[6] = {200, 300, 400, 600, 800, 2400};       fullSR.SetMT2Bins(5, mt2bins);}
    else if(njets_lo == 7 && nbjets_lo == 1){float mt2bins[6] = {200, 300, 400, 600, 800, 2400};      fullSR.SetMT2Bins(5, mt2bins);}
    else if(njets_lo == 7 && nbjets_lo == 2){float mt2bins[6] = {200, 300, 400, 600, 800, 2400};      fullSR.SetMT2Bins(5, mt2bins);}
    else if(njets_lo == 2 && nbjets_lo == 3){float mt2bins[6] = {200, 300, 400, 600, 800, 2400};      fullSR.SetMT2Bins(5, mt2bins);}
    else if(njets_lo == 7 && nbjets_lo == 3){float mt2bins[5] = {200, 300, 400, 600, 2400};      fullSR.SetMT2Bins(4, mt2bins);}
    else if(njets_lo == 7 && nbjets_lo == 4){float mt2bins[4] = {200, 300, 400, 2400};           fullSR.SetMT2Bins(3, mt2bins);}
    else if(njets_lo == 10 && nbjets_lo == 0){float mt2bins[4] = {200, 300, 500, 2400};          fullSR.SetMT2Bins(3, mt2bins);}
    else if(njets_lo == 10 && nbjets_lo == 1){float mt2bins[4] = {200, 300, 500, 2400};          fullSR.SetMT2Bins(3, mt2bins);}
    else if(njets_lo == 10 && nbjets_lo == 2){float mt2bins[4] = {200, 300, 500, 2400};          fullSR.SetMT2Bins(3, mt2bins);}
    else if(njets_lo == 10 && nbjets_lo == 3){float mt2bins[3] = {200, 300, 2400};               fullSR.SetMT2Bins(2, mt2bins);}
    else if(njets_lo == 10 && nbjets_lo == 4){float mt2bins[2] = {200, 2400};                    fullSR.SetMT2Bins(1, mt2bins);}
    SRVec.push_back(fullSR);
  }
  for(unsigned int iSR = 0; iSR < temp_SR_vec.size(); iSR++){
    if ((iSR >= 6 && iSR <= 8) || iSR == 10) continue; // The 7+ jet regions are VL, L only
    ...
    else if(njets_lo == 7 && nbjets_lo == 1){float mt2bins[6] = {200, 400, 600, 800, 1000, 2400};       fullSR.SetMT2Bins(5, mt2bins);}
    ...
    else if(njets_lo == 7 && nbjets_lo == 3){float mt2bins[4] = {200, 400, 600, 2400};                  fullSR.SetMT2Bins(3, mt2bins);}
    else if(njets_lo == 7 && nbjets_lo == 4){float mt2bins[3] = {200, 400, 2400};                       fullSR.SetMT2Bins(2, mt2bins);}
    else if(njets_lo == 10 && nbjets_lo == 0){float mt2bins[4] = {200, 400, 600, 2400};                 fullSR.SetMT2Bins(3, mt2bins);}
    else if(njets_lo == 10 && nbjets_lo == 1){float mt2bins[4] = {200, 400, 600, 2400};                 fullSR.SetMT2Bins(3, mt2bins);}
    else if(njets_lo == 10 && nbjets_lo == 2){float mt2bins[4] = {200, 400, 600, 2400};                 fullSR.SetMT2Bins(3, mt2bins);}
  ...
  // --- super signal regions, numbered 30 and up
  ...
  sr.SetVarCRSL("njets", 2, -1);
  sr.SetVarCRSL("nbjets", 0, -1);
  sr.SetVarCRSL("ht", 1200, -1);
  sr.SetVarCRSL("met", 30, -1);
  sr.SetVarCRDY("njets", 2, -1);
  sr.SetVarCRDY("nbjets", 0, -1);
  sr.SetVarCRDY("ht", 1200, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr30[] = {200, 400, 600, 800, 1000, 1200, 3000};
  sr.SetMT2Bins(6, mt2bins_sr30);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr31[] = {200, 400, 600, 800, 1000, 1400, 3000};
  sr.SetMT2Bins(6, mt2bins_sr31);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1200, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr32[] = {200, 400, 600, 800, 1000, 1400, 3000};
  sr.SetMT2Bins(6, mt2bins_sr32);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1500, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr33[] = {200, 400, 600, 800, 1000, 1400, 3000};
  sr.SetMT2Bins(6, mt2bins_sr33);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1200, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr34[] = {200, 400, 600, 800, 1000, 3000};
  sr.SetMT2Bins(5, mt2bins_sr34);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1500, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr35[] = {200, 400, 600, 800, 1000, 3000};
  sr.SetMT2Bins(5, mt2bins_sr35);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1200, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr36[] = {200, 400, 600, 800, 1000, 3000};
  sr.SetMT2Bins(5, mt2bins_sr36);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1500, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr37[] = {200, 400, 600, 800, 1000, 3000};
  sr.SetMT2Bins(5, mt2bins_sr37);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1200, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr38[] = {200, 400, 600, 800, 1000, 3000};
  sr.SetMT2Bins(5, mt2bins_sr38);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1500, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr39[] = {200, 400, 600, 800, 3000};
  sr.SetMT2Bins(4, mt2bins_sr39);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1200, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr40[] = {200, 400, 600, 3000};
  sr.SetMT2Bins(3, mt2bins_sr40);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1500, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr41[] = {200, 400, 600, 3000};
  sr.SetMT2Bins(3, mt2bins_sr41);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1200, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr42[] = {200, 400, 600, 3000};
  sr.SetMT2Bins(3, mt2bins_sr42);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1500, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr43[] = {200, 400, 600, 3000};
  sr.SetMT2Bins(3, mt2bins_sr43);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1200, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr44[] = {200, 400, 600, 3000};
  sr.SetMT2Bins(3, mt2bins_sr44);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1500, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr45[] = {200, 400, 3000};
  sr.SetMT2Bins(2, mt2bins_sr45);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1200, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr46[] = {200, 400, 600, 3000};
  sr.SetMT2Bins(3, mt2bins_sr46);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1500, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr47[] = {200, 400, 3000};
  sr.SetMT2Bins(2, mt2bins_sr47);
  SRVec.push_back(sr);
  sr.Clear();
  ...
  sr.SetVarCRDY("ht", 1200, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr48[] = {200, 400, 600, 3000};
  ...
  sr.SetVarCRDY("ht", 1500, -1);
  sr.SetVarCRDY("met", 30, -1);
  float mt2bins_sr49[] = {200, 400, 3000};
  sr.SetMT2Bins(2, mt2bins_sr49);
  SRVec.push_back(sr);
  sr.Clear();

  // set common variables in SSRs
  for(uint i=idx_first_ssr; i<SRVec.size(); i++){
      SRVec.at(i).SetVarCRRSInvertDPhi("njets", SRVec.at(i).GetLowerBound("njets"), SRVec.at(i).GetUpperBound("njets"));
      SRVec.at(i).SetVarCRRSInvertDPhi("nbjets", SRVec.at(i).GetLowerBound("nbjets"), SRVec.at(i).GetUpperBound("nbjets"));
      SRVec.at(i).SetVarCRRSInvertDPhi("ht", SRVec.at(i).GetLowerBound("ht"), SRVec.at(i).GetUpperBound("ht"));
      SRVec.at(i).SetVarCRRSInvertDPhi("met", SRVec.at(i).GetLowerBound("met"), SRVec.at(i).GetUpperBound("met"));
      SRVec.at(i).SetVarCRRSDPhiMT2("njets", SRVec.at(i).GetLowerBound("njets"), SRVec.at(i).GetUpperBound("njets"));
      SRVec.at(i).SetVarCRRSDPhiMT2("nbjets", SRVec.at(i).GetLowerBound("nbjets"), SRVec.at(i).GetUpperBound("nbjets"));
      SRVec.at(i).SetVarCRRSDPhiMT2("ht", SRVec.at(i).GetLowerBound("ht"), SRVec.at(i).GetUpperBound("ht"));
      SRVec.at(i).SetVarCRRSDPhiMT2("met", SRVec.at(i).GetLowerBound("met"), SRVec.at(i).GetUpperBound("met"));
      SRVec.at(i).SetVarCRRSMT2SideBand("njets", SRVec.at(i).GetLowerBound("njets"), SRVec.at(i).GetUpperBound("njets"));
      SRVec.at(i).SetVarCRRSMT2SideBand("nbjets", SRVec.at(i).GetLowerBound("nbjets"), SRVec.at(i).GetUpperBound("nbjets"));
      SRVec.at(i).SetVarCRRSMT2SideBand("ht", SRVec.at(i).GetLowerBound("ht"), SRVec.at(i).GetUpperBound("ht"));
      SRVec.at(i).SetVarCRRSMT2SideBand("met", SRVec.at(i).GetLowerBound("met"), SRVec.at(i).GetUpperBound("met"));
  }
