...
#declare -a inputs=(data_2017_${tag}.root mc_2017_${tag}.root data_2016_${tag}.root mc_2016_${tag}.root data_2018_${tag}.root)
declare -a inputs=(data_2017and2018_${tag}.root mc_2017_${tag}.root data_2016_${tag}.root mc_2016_${tag}.root)
#declare -a inputs=(data_2017_${tag}.root data_2016_${tag}.root)
#declare -a inputs=(data_2018_${tag}.root)
